<<<<<<< HEAD
# my_neovim_config
It's a my neo vim config, I started with a kickstarter and I change it.
=======
<<<<<<< HEAD
# my_neovim_config
It's a my neo vim config, I started with a kickstarter and I change it.
...
>>>>>>> 5c88be4 (my configuration)
>>>>>>> c38c101 (First steps on my configuration)
>>>>>>> 50fe9d7 (My firsts step)
